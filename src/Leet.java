...
public class Leet {
    ...
    // The key insight is permutation parity: each 3-element rotation is a cyclic permutation (3-cycle), 
	// which is an even permutation. 
	// Therefore, a permutation can be sorted only if it has even parity (even number of inversions).
    // The simplest solution is to count inversions
